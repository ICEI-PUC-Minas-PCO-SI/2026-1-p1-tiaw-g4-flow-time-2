...
| RF-004 | Sistema de foco (Pomodoro/cronômetro) | ALTA      |
| RF-005 | Bloqueio de distrações| MÉDIA     |
| RF-006 | Notificações inteligentes| ALTA   |
| RF-007 | Visualização de progresso| MÉDIA     |
| RF-008 | Feedback motivacional inteligente| MÉDIA     |
| RF-009 | Gamificação|BAIXA     |
| RF-010 | Gestão de rotina saudável| MÉDIA     |
| RF-011 | Ajuste adaptativo da rotina| BAIXA    |
| RF-012 | Interface simplificada| ALTA     |
...
| RNF-002 | Escalabilidade | BAIXA      |
| RNF-003 | Segurança | ALTA    |
| RNF-004 | Usabilidade | ALTA     |
| RNF-005 | Não gerar ansiedade |MÉDIA   |
| RNF-006 | Eficiência energética (mobile) | BAIXA   |
| RNF-007 | Disponibilidade |MÉDIA  |
| RNF-008 | Confiabilidade | ALTA    |
| RNF-009 | Personalização |BAIXA   |
